...
export const UserGroupIcon: React.FC<IconProps> = ({ 
  ...
  >
    <path 
      ...
      strokeLinejoin="round" 
      strokeWidth={strokeWidth} 
      d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a6.731 6.731 0 00-2.556 4.026m0 0a5.971 5.971 0 00-.941 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" 
    />
  </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ 
  ...
  >
    <path 
      ...
      strokeLinejoin="round" 
      strokeWidth={strokeWidth} 
      d="M8.25 12h.008M12 12h.008M15.75 12h.008M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 6.732 6.732 0 01-1.5 1.5c-.25.25-.5.5-.75.75a6.732 6.732 0 01-1.5 1.5 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 018.25 21H3a3 3 0 01-3-3V6a3 3 0 013-3h18a3 3 0 013 3v6z" 
    />
  </svg>
); 